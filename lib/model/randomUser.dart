...
//
//     final randome = randomeFromJson(jsonString);

import 'dart:convert';

Randome randomeFromJson(String str) => Randome.fromJson(json.decode(str));

String randomeToJson(Randome data) => json.encode(data.toJson());
...
class Randome {
  ...
  factory Randome.fromJson(Map<String, dynamic> json) => Randome(
